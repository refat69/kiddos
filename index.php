    ...
    <section class="ftco-gallery">
        <div class="container-wrap">
            <div class="row no-gutters">
              ...
              <?php
                $selg="SELECT * FROM gallery ORDER BY gallery_id ASC";
                $Qg=mysqli_query($con,$selg);
                while($gallery=mysqli_fetch_assoc($Qg)){
               ?>
                <div class="col-md-3 ftco-animate">
                    <a href="admin/uploads/<?=$gallery['gallery_image']?>" class="gallery image-popup img d-flex align-items-center" style="background-image: url(admin-panel/assets/uploads/<?=$gallery['gallery_image']?>);">
